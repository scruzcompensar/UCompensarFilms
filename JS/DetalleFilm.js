...
const idTarjeta = obtenerIdTarjetaDeURL();

// Función para obtener el ID de la tarjeta de la URL
function obtenerIdTarjetaDeURL() {
...
const pelicula = buscarPorId(idTarjeta);
function buscarPorId(id) {
    const peliculaEncontrada = datosPeliculas.find(tarjeta => {
        return tarjeta.id === id;
    });
    return peliculaEncontrada;
}

//Inicio carga de datos de la pagina

//Carga fondo
const fondo = document.querySelector('.header');
fondo.style.backgroundImage = `url(${pelicula.fondo})`;
...
const reparto1 = document.querySelector('.reparto-1');
...
const reparto2 = document.querySelector('.reparto-2');
...
const reparto3 = document.querySelector('.reparto-3');
...
const reparto4 = document.querySelector('.reparto-4');
...
const reparto5 = document.querySelector('.reparto-5');
reparto5.style.backgroundImage = `url(${pelicula.reparto5Img})`;
const repartoNombre5 = reparto5.querySelector('h3');
repartoNombre5.textContent = pelicula.reparto5;
const repartoPtr5 = reparto5.querySelector('p');
repartoPtr5.textContent = pelicula.reparto5ptr;

//Fin Carga de datos de la pagina